...
static int program_header(elf_dt *elfen);
...
int main(int argc, char **argv)
{
	...
	if (elfen.ph32)
		free(elfen.ph32), elfen.ph32 = NULL;
	if (elfen.ph64)
		free(elfen.ph64), elfen.ph64 = NULL;
	return (0);
}
...
/**
 * program_header - manages print of program header information from input file
